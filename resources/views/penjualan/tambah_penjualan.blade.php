...
@section('content')
	    <div class="container">
	     	<div class="row"></div>
	     	<h4 style="color: #448aff;">Tambah Penjualan</h4>
	     	<div class="line">
	     	</div><br>
     			...
     			{{ csrf_field() }}
				    <div class="row">
				        ...
				        <div align="center" class="col s12">
				        	<a class="btn-flat waves-effect waves-light red" href="/penjualan" style="color: white;"><i class="material-icons left">cancel</i>Batal</a>
