      ...
      <div class="navbar-fixed">
        <nav>
          <div class="nav-wrapper">
            <a href="/home" class="brand-logo" style="margin-left: 20px; font-size: 23px;"><img class="left" style="height: 62px; width: 62px;" src="/inventory/INVENTORYY/public/images/logo.png">AVHERINDO JAYA SPORT</a>
          </div>
        </nav>
      </div>
      <!-- end navbar -->
            ...
            <div class="col s12 z-depth-6 card-panel">
              ...
              {{ csrf_field() }}
                  ...
                  <div class="input-field col s12 center">
                    <img src="/inventory/INVENTORYY/public/images/logo.png" style="width: 250px; height: 250px;" alt="" class="responsive-img valign profile-image-login">
                  </div>
